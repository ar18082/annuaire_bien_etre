 ...
 */
final class Version20230521145757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images ADD prestataire_id INT DEFAULT NULL, ADD categorie_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E01FBE6ABCF5E72D ON images (categorie_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E01FBE6ABCF5E72D ON images');
        $this->addSql('ALTER TABLE images DROP prestataire_id, DROP categorie_id');
    }
}
